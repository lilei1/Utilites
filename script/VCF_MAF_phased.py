...
#by Li Lei, 2021/02/04
#   A script to calculate the alt allele frequency in a VCF file, which is generagted from GATK4 (mixed with some phased genotypes, such as "1|1","0|1",etc.
        ...
        #   This defines how many samples in the VCF
            ...
            if 'AD' not in format:
                ...
                for g in genotypes:
                    ...
                    #if z:
                    #print (call)
                    if call == '1|1' or call == '0|1' or call == '1|0' or call == '1|0' or call == '0|0' or call == '.|.':
                        alleles = call.split('|')
                    else:
                        alleles = call.split('/')
                    #print (alleles)   
                    ...
                    for x in alleles:
                        if x == '.': #ignor the missing data
                            continue
                                #g_column.append( 'N')
                                #individual_call += 'N'
                        #if x == '1|1' or x == '0|1' or x == '1|0' or x == '1|0':
                            #ys = x.split('|')
                            #print (ys)
                        else:
                            #print (x)
